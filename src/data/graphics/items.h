...
const u32 gItemIcon_LightStone[] = INCBIN_U32("graphics/items/icons/light_stone.4bpp.lz");
const u32 gItemIconPalette_LightStone[] = INCBIN_U32("graphics/items/icon_palettes/light_stone.gbapal.lz");

const u32 gItemIcon_DarkStone[] = INCBIN_U32("graphics/items/icons/dark_stone.4bpp.lz");
const u32 gItemIconPalette_DarkStone[] = INCBIN_U32("graphics/items/icon_palettes/dark_stone.gbapal.lz");
