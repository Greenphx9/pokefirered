...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_TANGELA] =          {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_TANGROWTH, 0}},
	...
	//[SPECIES_AIPOM] =            {{EVO_MOVE, MOVE_DOUBLE_HIT, SPECIES_AMBIPOM, 0}},
	[SPECIES_SUNKERN] =          {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SUNFLORA, 0}},
	[SPECIES_YANMA] =            {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_YANMEGA, 0}},
	...
	[SPECIES_PILOSWINE] =        {{EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_MAMOSWINE, 0}},
	...
	//[SPECIES_RAYQUAZA] =         {{EVO_MEGA, MOVE_DRAGONASCENT, SPECIES_RAYQUAZA_MEGA, MEGA_VARIANT_WISH}}, //Dragon Ascent not defined (yet)
