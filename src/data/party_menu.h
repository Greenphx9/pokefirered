...
} const sCursorOptions[] =
{
    ...
    // TODO: Fix
    /*[CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_FLASH]       = {gMovesInfo[MOVE_FLASH].name,       CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_CUT]         = {gMovesInfo[MOVE_CUT].name,         CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_FLY]         = {gMovesInfo[MOVE_FLY].name,         CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_STRENGTH]    = {gMovesInfo[MOVE_STRENGTH].name,    CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_SURF]        = {gMovesInfo[MOVE_SURF].name,        CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_ROCK_SMASH]  = {gMovesInfo[MOVE_ROCK_SMASH].name,  CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_WATERFALL]   = {gMovesInfo[MOVE_WATERFALL].name,   CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_TELEPORT]    = {gMovesInfo[MOVE_TELEPORT].name,    CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_DIG]         = {gMovesInfo[MOVE_DIG].name,         CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_MILK_DRINK]  = {gMovesInfo[MOVE_MILK_DRINK].name,  CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_SOFT_BOILED] = {gMovesInfo[MOVE_SOFT_BOILED].name, CursorCB_FieldMove},
    [CURSOR_OPTION_FIELD_MOVES + FIELD_MOVE_SWEET_SCENT] = {gMovesInfo[MOVE_SWEET_SCENT].name, CursorCB_FieldMove},*/
};
