...
static void DisplayPartyPokemonDataToTeachMove(u8 slot, u16 item);
...
static void ItemTask_ReturnToSelectMon(u8 taskId)
{
    gPartyMenuUseExitCallback = FALSE;
    PlaySE(SE_SELECT);
    ScheduleBgCopyTilemapToVram(2);
...
void Task_AbilityCapsule(u8 taskId)
{
    ...
    case 0:
        ...
        if (GetAbilityBySpecies(tSpecies, 0) == GetAbilityBySpecies(tSpecies, 1)
            || GetAbilityBySpecies(tSpecies, 1) == ABILITY_NONE
            || tAbilityNum > 1
            || !tSpecies)
        {
            gPartyMenuUseExitCallback = FALSE;
    ...
    case 2:
        ...
        case 1:
        case MENU_B_PRESSED:
            ItemTask_ReturnToSelectMon(taskId);
            return;
        }
        break;
    case 3:
